...
==ADD (Practice Report Part I): Critical readiness gap establishes urgency: While 86-92% students use AI, only 61% faculty have used it, 88% of those "minimally" (vs. 9% faculty regular users vs. 27% student regular users). Bottom-up adoption driven by efficiency (51% "save time," 50% "improve quality") vs. lagging institutional response (only 39% have AI policies). Result: 80% students say university AI integration doesn't meet expectations; 58% feel they lack AI skills; 59% leaders believe graduates unprepared for AI workplaces. Efficiency-oriented student mindset conflicts with process-oriented pedagogical goals—frames the design awareness problem.==

**Sources:** Carnegie Report (Sullivan et al., 2007) for opening problem; Nature (2025) and UK Higher Education Policy Institute for AI adoption statistics; position as "everyone uses AI, but not intentionally for multi-handle design." ==Practice Report Tables 1-2 and Part I for readiness gap statistics.==
...
==ADD (Practice Report Part II): AI content generation reveals quality chasm strengthening the intentional design argument: AI-generated lesson plans are "moderate to low quality," rarely cultivate higher-order thinking (nearly 50% of 2,230 activities at lowest cognitive level "remember"). However, student-facing AI (chatbots/intelligent tutoring) shows large positive effect (Hedges' g=1.02, p<0.0001). This demonstrates AI is more effective in responsive/scaffolding roles than proactive generative roles—BUT this chasm exists because current AI use lacks intentional multi-handle design. When educators specify only rational outcomes ("generate quiz"), AI delivers single-handle materials. Multiply-loaded pedagogy addresses this by bringing design intentionality to AI specification.==

**Sources:** Meta-analyses for handle evidence (Tyng et al. 2017; Macedonia & Kriegstein 2022; Double et al. 2020; Noetel et al. 2022; Black & Wiliam 1998). Sweller (1988, 2011) and Paivio (1986) for cognitive architecture. Begolli et al. (2020) for simultaneous>sequential finding. Boysen (2021, 2024) and Hills et al. (2022) for devastating UDL critique. Kalyuga et al. (1999) for redundancy warning (quality>quantity). ==Practice Report Table 2 and Part II (Use Cases 1, 6) for quality chasm findings.==
...
==ADD (Practice Report Part III): Strengthen metacognitive handle with AI-specific evidence: Students actively use AI as "metacognitive scaffold" for planning (checklists), monitoring (comparing feedback), and evaluating understanding (explaining errors). Qualitative analysis of 834 journal entries shows externalization of metacognitive strategies. One system requiring students to explain reasoning and declare confidence before AI feedback explicitly promoted self-regulated learning. For emotional handle: AI-enhanced Social-Emotional Learning framework significantly boosted engagement and emotional well-being in EFL students, facilitating better emotional regulation. Students describe AI as "safety net" reducing anxiety about writing/asking questions due to non-judgmental nature. These findings show AI can intentionally engage metacognitive and emotional handles, not just rational.==

**Sources:** Cite specific meta-analyses and effect sizes to ground each handle empirically; emphasize these are established findings, not speculative. ==Practice Report Part III (Section 3.2, 3.3) for AI-specific metacognitive and emotional evidence.==
...
**Sources:** Hills et al. (2022) on time constraints faculty face; Nature (2025) on AI adoption; position against typical AI-in-education literature focused on efficiency (grading, summarization). MIT EEG study and Tsinghua findings on concerning AI effects when used for automation rather than intentional design.
...
--- ==Practice Report Part III.4 for "personalisation without isolation" model (note: lacks empirical validation).==
...
==ADD (Practice Report Part II, Use Case 6): CRITICAL caveat on AI interaction—"crisis of credibility": While intelligent tutoring shows large positive effect (Hedges' g=1.02), students exhibit strong bias against AI feedback when source is disclosed. Lee & Moore (2024): students preferred AI-generated feedback quality in blind comparison, but only explicitly labeled AI feedback suffered decline in perceived "genuineness" after disclosure. This threatens proven efficacy of AI tutoring/role-play. Implementation implication: Consider human-AI co-production of feedback, focus on building student AI literacy to mitigate source bias. The technical effectiveness is proven; the psychological acceptance requires intentional design.==
...
**4.E Example: Student-Created Assessment Materials** (~400 words) ==Practice Report Part II (Use Case 6) and Lee  Moore (2024) for credibility crisis.==
...
==ADD (Practice Report Part II, Use Case 2 & Gap 2): Important caveat on AI-generated assessments: While AI can generate quizzes and rubrics (Use Case 2), the practice report identifies critical research gap—empirical studies evaluating quality, fairness, reliability, and pedagogical alignment of AI-created assessment instruments are lacking. When implementing Example 4.E (student-created questions), acknowledge this limitation: use AI-generated materials as starting point requiring human validation, not final product. The assessment creation process develops student understanding (Van Deursen 2016), but quality assurance requires pedagogical judgment AI cannot yet reliably provide.==
...
==ADD (Practice Report Part I): Strengthen urgency of faculty development in prompt engineering/design awareness: Only 17% of faculty rate their AI literacy as advanced/expert, despite 61% having used AI (88% minimally). This creates acute need for practical guidance in intentional AI use. Students report similar gaps: 58% feel they lack sufficient AI knowledge/skills. Yet 59% of higher education leaders believe recent graduates not prepared for AI workplaces. The faculty development challenge isn't just adopting AI (happening already) but developing design literacy—shifting from automated replication of single-handle approaches to intentional multiply-loaded specification. This section addresses that development need directly.==
...
**5.A Practical Prompting Strategies** (~500 words) ==Practice Report Part I for AI literacy gap data.==
...
**Sources:** Cite all five research findings directly with specific studies; MIT EEG, Tsinghua, Nature (2025) for AI concerns; acknowledge this is theoretical argument + proof-of-concept, not empirical validation; identify research questions requiring study.
...
==ADD (Practice Report Part III.1): CRITICAL nuance on AI's impact on rational thinking/critical thinking—it's mode-dependent, not technology-inherent: Frequency of AI use unrelated to critical thinking skills; however, using AI specifically for reflective thinking positively correlated with critical thinking development (Xu et al. 2025). Students using LLMs for research tasks showed poorer reasoning and narrower ideas vs. traditional search. BUT when used as auxiliary tool in structured environment, AI can effectively promote higher-order thinking. Systematic review: ChatGPT can enhance critical thinking, but overuse diminishes motivation for self-reflection. This reinforces the multiply-loaded pedagogy argument: intentional design for metacognitive engagement (Example 4.A empathy calibration, 4.B error detection, 4.D role-play probing boundaries) counteracts shallow use. When NOT to multiply-load: if goal is simple information retrieval or when students lack foundational knowledge to engage reflectively—focused rational instruction first, then integration.==
...
**6.B AI System Limitations and Risks** (~400 words) ==Practice Report Part III.1 for mode-dependent critical thinking impacts; Xu et al. (2025) for reflective use correlation.==

**Purpose:** Address technical limitations and ethical concerns—user's law & tech expertise enables sophisticated treatment.

**Arguments:** AI generates plausible but sometimes inaccurate content—requires faculty fact-checking (especially case citations, statutory references). Systems may reflect training data biases (representation, stereotyping)—requires critical review. Access inequities if institutions lack resources. Student over-reliance risks shallow learning (MIT EEG: weakest connectivity; Tsinghua: lower retention 2-3 weeks later). Privacy concerns with student data in prompts. Prompt engineering skill development requires time investment (not zero-cost). AI cannot replace pedagogical judgment about learning objectives, assessment criteria, student needs. Technology changes rapidly—specific tools may become obsolete, but design principle remains. Multiply-loaded pedagogy shouldn't increase surveillance or reduce human teaching—it's design support, not replacement.

**Sources:** Nature (2025), MIT EEG, Tsinghua studies on concerning AI effects; user's GDPR expertise for privacy concerns; acknowledge technology limitations honestly while defending principle.

---

==ADD (Practice Report Part I & III.1): Expand concerning cognitive effects with specifics: Harvard RCT found physics undergrads using AI tutor "learnt more in less time" BUT Tsinghua study: students scored higher initially but lower 2-3 weeks later (retention problem). MIT EEG study: students using ChatGPT showed "weakest connectivity" in brain patterns. Students "sometimes barely remember a word of their prose" when AI-assisted. Mechanism: AI may reduce germane cognitive load (schema construction) while appearing helpful—creates illusion of understanding. Nature (2025): 86% of students regularly use AI, but usage without intentional pedagogical design risks shallow engagement. This strengthens multiply-loaded pedagogy argument: when AI use is designed for metacognitive engagement (self-explanation, error detection, boundary testing), it maintains germane load while providing scaffolding. The risk isn't AI itself but unreflective automation. Multiply-loaded design explicitly counters this by requiring active cognitive engagement across multiple dimensions simultaneously.==
...
**Arguments:** This article provides theoretical framework and proof-of-concept; rigorous validation needed. Key questions: (1) **Comparative effectiveness**—do multiply-loaded materials outperform traditional or UDL approaches? Measure retention (immediate, 6-week, 6-month), transfer to novel problems, cognitive load during learning. (2) **Optimal loading levels**—how many handles for different expertise levels, content complexity, student backgrounds? (3) **Equity effects**—do multiply-loaded materials reduce achievement gaps as UDL claims but doesn't deliver? Disaggregate by first-generation status, socioeconomic background. (4) **Long-term professional development**—does multiply-loaded pedagogy in law school predict better lawyering (client empathy, ethical reasoning, contextual analysis)? (5) **Implementation fidelity**—can principle scale across institutions without quality degradation? **Methodological needs:**experimental/quasi-experimental designs, cognitive load measurement (subjective + objective), longitudinal follow-ups, qualitative components exploring student experience, international comparative studies (Norwegian context unexplored in legal pedagogy). ==Practice Report Part I for adoption statistics; Part III.1 for detailed cognitive effects (Harvard, Tsinghua, MIT studies); emphasize these support intentional design argument.==

==ADD (Practice Report Part IV): Integrate five specific research gaps identified in systematic AI literature review: (1) Empirical validation of "personalisation without isolation" model and other social learning frameworks—compelling pedagogically but lack empirical evidence of effectiveness on collaborative/communicative skills. (2) Quality and validity of AI-generated assessments—capability widely noted but empirical validation of quality, fairness, reliability, pedagogical alignment lacking (critical for Section 4.E implementation). (3) Longitudinal studies on skill development—overwhelming majority of AI research is cross-sectional; need long-term studies on sustained AI use effects on critical thinking, metacognition, domain knowledge retention. (4) Sensory dimension of AI-generated content—"significant void" in literature on AI tools creating multi-sensory learning experiences in higher education (relates to sensory handle in multiply-loaded design). (5) Equity and algorithmic bias—differential impacts on students with disabilities, varying socioeconomic backgrounds, non-native speakers (AI plagiarism detection may be biased against non-native writing patterns). These gaps align directly with multiply-loaded pedagogy research needs, showing the field recognizes multi-dimensional integration as critical frontier.==
...
### **7. Conclusion: Design Awareness for the AI Era** (~600 words) ==Practice Report Part IV for five specific research gaps; these gaps from AI literature review independently validate multiply-loaded pedagogy's research directions.==
...
==ADD (Practice Report Part I): Strengthen urgency in conclusion by returning to readiness gap: The 86% student adoption isn't just statistic—it represents systemic asymmetry where students (51% seeking efficiency, 50% quality improvement) have adopted AI faster than institutions can respond (only 39% have policies, 61% faculty used it but 88% minimally). Result: 80% of students report university AI integration doesn't meet expectations. This gap makes multiply-loaded pedagogy urgent, not optional. If educators don't develop design literacy, students will continue using AI for efficiency-oriented automation (copying answers, outsourcing thinking) rather than intentional learning. The article offers path from reactive adoption to intentional design—from "students are using AI anyway" to "we can design AI-enabled learning that genuinely serves pedagogical goals." Multiply-loaded pedagogy addresses the readiness gap not just by providing tools but by developing design awareness that matches student practice with institutional mission.==
...
**7.A Implications for Different Stakeholders** (~300 words) ==Practice Report Part I for readiness gap data reinforcing urgency of design awareness development.==
